...
if ( ! class_exists( 'FP_Abstract_Plugin' ) ):
 ...
 */
abstract class FP_Abstract_Plugin
{
    /**
    ...
    {
        return !in_array($email_type, array(
            'new_order',
            'cancelled_order',
            'failed_order',
     ...
     * @return  array<string, mixed>    Associative array with index "function" and "class".
     */
